...
<%@ page import="com.psj.JobApp.model.JobPost" %>
...
<head>
 ...
 /* Style for success message */
         ...
         #success-message {
                     ...
                     animation: fadeIn 0.5s ease-out forwards; /* Animation for fade in */
                 }
...
<nav class="navbar navbar-expand-lg navbar-light bg-clr">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium" href="#">Online Job Portal</a>
...
<!-- Success message -->
<div id="success-message">Job Post Added Successfully</div>
