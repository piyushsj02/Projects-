...
<%@ page isELIgnored="false"%>
	...
	<body>
		...
		<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #dadada;">
			<div class="container">
				<a class="navbar-brand fs-1 fw-medium" href="#">Online Job
					Portal</a>
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav ms-auto">
						...
						<li class="nav-item"><a class="nav-link" href="https://google.com/">Contact</a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="col-md-6">
					<div class="card">
						<div class="card-body">
							...
							<div class="mb-1" style="background-color: #dadada;" >
								<div class="mb-1" >
									<label for="postId" class="form-label">Post ID</label> <input
										type="number" class="form-control" id="postId" name="postId"
										required>
								</div>
